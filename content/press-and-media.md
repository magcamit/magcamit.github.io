...
- The Monocle Radio (8 June 2020), The Philippine Anti-Terror Bill. (Starts at 28:30)
{% alert(type="warning", title="Broken link") %}
- Link does not work: `https://monocle.com/radio/shows/the-globalist/2246/`.
{% end %}
...
- The Monocle Radio (13 May 2019), Populist Leaders. (Starts at 29:30)
{% alert(type="warning", title="Broken link") %}
- Link does not work: `https://monocle.com/radio/shows/the-globalist/1966/`.
{% end %}
...
- The New Lens (10 March 2017), [Dutertes Populism and Philippine Foreign Policy: Implications for China-Philippine Relations](https://international.thenewslens.com/article/63497).
...
- The Asia Dialogue (17 March 2017), Rodrigo Duterte and the Making of a Populist Demigod (Part 1 and Part 2).
{% alert(type="warning", title="Broken links") %}
- Link does not work: `https://theasiadialogue.com/2017/03/17/rodrigo-duterte-and-the-making-of-a-populist-demigod-part-1/`.
- Link does not work: `https://theasiadialogue.com/2017/03/17/rodrigo-duterte-and-the-making-of-a-populist-demigod-part-2/`.
{% end %}
