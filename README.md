...
[![Build and deploy Zola website](https://github.com/magcamit/magcamit.github.io/actions/workflows/publish.yaml/badge.svg)](https://github.com/magcamit/magcamit.github.io/actions/workflows/publish.yaml)

This repository containst the contents for the website [https://www.magcamit.com](https://www.magcamit.com). Experimentation/staging content are typically in the `experimental` branch, and maybe published at [https://magcamit.netlify.app/](https://magcamit.netlify.app/).
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/magcamit/magcamit.github.io.git
   ```
